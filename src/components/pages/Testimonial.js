import { Carousel, Typography, Avatar, Image, Card } from 'antd';
            ...
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className="col-md-2" style={{ backgroundColor: "#fff" }}>
                        <img alt="example" src="https://www.tagtoday.net/hs-fs/hubfs/iponweb%20logo.png?width=256&name=iponweb%20logo.png" />

                    </div>
                    <div className="col-md-2" style={{ backgroundColor: "#fff" }}>
                        <img alt="example" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEl3tM7ofijBzOOeKN2vI1lcw-cy1xARofOi1mWdkmtU6lCBf2ac31kX2z6yb9HbBSEwo&usqp=CAU" />
                    </div>
                    <div className="col-md-2" style={{ backgroundColor: "#fff" }}>
                        <img alt="example" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRzwIMzkmQbrTlodjAK3BbeKHaFylkRNUGdwg&usqp=CAU" />

                    </div>
                    <div className="col-md-2" style={{ backgroundColor: "#fff" }}>
                        <img alt="example" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTv6_VgyLsFIt1EDwYV-0p5P0qm9PlEq7Dxww&usqp=CAU" />
                    </div>
